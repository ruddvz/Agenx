...
5. **Read `planning/PRODUCT-PHASES.md`** — confirm current lifecycle phase; classify the incoming task; apply gate rule from `skills/project/lifecycle.md`

Only after all five steps are complete, proceed to the relevant workflow below.
